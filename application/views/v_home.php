		...
		<div class="container-fluid">
			<div class="row owl-carousel" id="travel_cat">
				<div class="single_travel wow fadeIn" data-wow-duration="1s">
					<figure>
						<img class="img-fluid" src="<?php echo base_url() ?>assett/img/travel/t1.jpg" alt="">
					</figure>
				...
				<div class="single_travel wow fadeIn" data-wow-duration="1s" data-wow-delay=".3s">
					<figure>
						<img class="img-fluid" src="<?php echo base_url() ?>assett/img/travel/t2.jpg" alt="">
					</figure>
					<div class="overlay"></div>
					<div class="text-wrap">
						<h3>
				...
				<div class="single_travel wow fadeIn" data-wow-duration="1s" data-wow-delay=".6s">
					<figure>
						<img class="img-fluid" src="<?php echo base_url() ?>assett/img/travel/t3.jpg" alt="">
					</figure>
					<div class="overlay"></div>
					<div class="text-wrap">
						<h3>
			...
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<div class="single_travel wow fadeInUp" data-wow-duration="1s">
						<figure>
							<img class="img-fluid w-100" src="<?php echo base_url() ?>assett/img/blog-post/b1.jpg" alt="">
						</figure>
						<div class="overlay"></div>
						<div class="text-wrap">
							<h3>
				...
				<div class="col-lg-3 col-md-6">
					<div class="single_travel wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
						<figure>
							<img class="img-fluid w-100" src="<?php echo base_url() ?>assett/img/blog-post/b2.jpg" alt="">
						</figure>
						<div class="overlay"></div>
						<div class="text-wrap">
							<h3>
				...
				<div class="col-lg-3 col-md-6">
					<div class="single_travel wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
						<figure>
							<img class="img-fluid w-100" src="<?php echo base_url() ?>assett/img/blog-post/b3.jpg" alt="">
						</figure>
						<div class="overlay"></div>
						<div class="text-wrap">
							<h3>
				...
				<div class="col-lg-3 col-md-6">
					<div class="single_travel wow fadeInUp mt--60" data-wow-duration="1s" data-wow-delay=".6s">
						<figure>
							<img class="img-fluid w-100" src="<?php echo base_url() ?>assett/img/blog-post/b4.jpg" alt="">
						</figure>
						<div class="overlay"></div>
						<div class="text-wrap">
							<h3>
				...
				<div class="col-lg-3 col-md-6">
					<div class="single_travel wow fadeInUp mt--60" data-wow-duration="1s" data-wow-delay=".8s">
						<figure>
							<img class="img-fluid w-100" src="<?php echo base_url() ?>assett/img/blog-post/b5.jpg" alt="">
						</figure>
						<div class="overlay"></div>
						<div class="text-wrap">
							<h3>
				...
				<div class="col-lg-6 col-md-12">
					<div class="single_travel wow fadeInUp" data-wow-duration="1s" data-wow-delay="1s">
						<figure>
							<img class="img-fluid w-100" src="<?php echo base_url() ?>assett/img/blog-post/b6.jpg" alt="">
						</figure>
						<div class="overlay"></div>
						<div class="text-wrap">
							<h3>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					<div class="single_place wow fadeIn text-center mt-240" data-wow-duration="1s" data-wow-delay=".2s">
						<img class="img-fluid w-100" src="<?php echo base_url() ?>assett/img/places/p2.jpg" alt="">
						<div class="overlay"></div>
						<h4>Waterfall
							<br> Mountain Island</h4>
					</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="single_place wow fadeIn text-center" data-wow-duration="1s" data-wow-delay=".4s">
						<img class="img-fluid w-100" src="<?php echo base_url() ?>assett/img/places/p4.jpg" alt="">
						<div class="overlay"></div>
						<h4>Waterfall
							<br> Mountain Island</h4>
					</div>
					<div class="single_place wow fadeIn text-center" data-wow-duration="1s" data-wow-delay=".8s">
						<img class="img-fluid w-100" src="<?php echo base_url() ?>assett/img/places/p5.jpg" alt="">
						<div class="overlay"></div>
						<h4>Waterfall
							<br> Mountain Island</h4>
					</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="single_place wow fadeIn text-center mt-240" data-wow-duration="1s" data-wow-delay=".6s">
						<img class="img-fluid w-100" src="<?php echo base_url() ?>assett/img/places/p6.jpg" alt="">
						<div class="overlay"></div>
						<h4>Waterfall
							<br> Mountain Island</h4>
					</div>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="single-popular-post d-flex align-items-center flex-row">
						<div class="icon">
							<img src="<?php echo base_url() ?>assett/img/popular-post/p1.jpg" alt="">
						</div>
						<div class="desc">
							<h4>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-popular-post d-flex align-items-center flex-row">
						<div class="icon">
							<img src="<?php echo base_url() ?>assett/img/popular-post/p2.jpg" alt="">
						</div>
						<div class="desc">
							<h4>
								<a href="#">Waterfall Mountain Visit</a>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-popular-post d-flex align-items-center flex-row">
						<div class="icon">
							<img src="<?php echo base_url() ?>assett/img/popular-post/p3.jpg" alt="">
						</div>
						<div class="desc">
							<h4>
								<a href="#">Waterfall Mountain Visit</a>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-popular-post d-flex align-items-center flex-row">
						<div class="icon">
							<img src="<?php echo base_url() ?>assett/img/popular-post/p4.jpg" alt="">
						</div>
						<div class="desc">
							<h4>
								<a href="#">Waterfall Mountain Visit</a>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-popular-post d-flex align-items-center flex-row">
						<div class="icon">
							<img src="<?php echo base_url() ?>assett/img/popular-post/p5.jpg" alt="">
						</div>
						<div class="desc">
							<h4>
								<a href="#">Waterfall Mountain Visit</a>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-popular-post d-flex align-items-center flex-row">
						<div class="icon">
							<img src="<?php echo base_url() ?>assett/img/popular-post/p6.jpg" alt="">
						</div>
						<div class="desc">
							<h4>
								<a href="#">Waterfall Mountain Visit</a>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-popular-post d-flex align-items-center flex-row">
						<div class="icon">
							<img src="<?php echo base_url() ?>assett/img/popular-post/p7.jpg" alt="">
						</div>
						<div class="desc">
							<h4>
								<a href="#">Waterfall Mountain Visit</a>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-popular-post d-flex align-items-center flex-row">
						<div class="icon">
							<img src="<?php echo base_url() ?>assett/img/popular-post/p8.jpg" alt="">
						</div>
						<div class="desc">
							<h4>
								<a href="#">Waterfall Mountain Visit</a>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-popular-post d-flex align-items-center flex-row">
						<div class="icon">
							<img src="<?php echo base_url() ?>assett/img/popular-post/p9.jpg" alt="">
						</div>
						<div class="desc">
							<h4>
								<a href="#">Waterfall Mountain Visit</a>
