            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <?php
                        ...
                        $cek = $this->db->query("SELECT * FROM t_kuliner WHERE id='".$next_idku."'")->num_rows();
                        if ($cek == 0) {
                    ...
                    <div class="navigation-area">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                                ...
                                <div class="thumb">
                                    <a href="<?php if ($prev_idku != 0) { echo site_url().'Content/index/'.$prev_idku.'/'.$Cate; }?>"><img class="img-fluid" src="<?php echo base_url() ?>assett/img/blog/nxt4.png" alt=""></a>
                                </div>
                                <div class="arrow">
                                    <a href="<?php if ($prev_idku != 0) { echo site_url().'Content/index/'.$prev_idku.'/'.$Cate; }?>"><span class="lnr text-white lnr-arrow-left"></span></a>
                                </div>
                                <div class="detials">
                                    <p>Prev Post</p>
                                    <a href="<?php if ($prev_idku != 0) { echo site_url().'Content/index/'.$prev_idku.'/'.$Cate; }?>">
                            ...
                            <div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
                                <div class="detials">
                                    <p>Next Post</p>
                                    <a href="<?php echo site_url().'Content/index/'.$next_idku.'/'.$Cate; ?>">
                                       <!--  <h4>Cartridge Is Better</h4> -->
                                    </a>
                                </div>
                                <div class="arrow">
                                    <a href="<?php echo site_url().'Content/index/'.$next_idku.'/'.$Cate; ?>"><span class="lnr text-white lnr-arrow-right"></span></a>
                                </div>
                                <div class="thumb">
                                    <a href="<?php echo site_url().'Content/index/'.$next_idku.'/'.$Cate; ?>"><img class="img-fluid" src="<?php echo base_url() ?>assett/img/blog/nxt3.png" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
