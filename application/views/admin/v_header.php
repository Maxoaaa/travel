...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url() ?>assetadmin/dist/css/skins/_all-skins.min.css">
  <!-- <link rel="stylesheet" href="<?php echo base_url() ?>assetadmin/dist/css/skins/_all-skins.min.css"> -->
   <!-- <link rel="stylesheet" href="<?php echo base_url() ?>assetadmin/bower_components/morris.js/morris.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo site_url() ?>" class="logo">
      ...
      <span class="logo-lg"><b>Noesantara</b> Travel</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo site_url('admin/Administrator/logout'); ?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li> 
